...
# resource "google_dns_record_set" "ibo_redis_a_record_qa" {
#   count        = var.environment == "dev" ? 1 : 0    
#   name         = "ibo.redis-qa.${google_dns_managed_zone.private-dns-managed-zone.dns_name}"
#   managed_zone = google_dns_managed_zone.private-dns-managed-zone.name
#   type         = "A"
#   ttl          = 300
#   rrdatas      = [module.ibo_redis_qa[0].ip]
# }
