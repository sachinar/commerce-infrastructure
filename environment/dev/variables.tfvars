...
gke_namespaces          = ["inventory", "ebo", "node-master", "order-service", "promise-service", "logistics-service", "node-master-qa", "order-service-qa", "promise-service-qa", "logistics-service-qa", "order-orchestration", "order-orchestration-qa"]
